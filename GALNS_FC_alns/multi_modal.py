...
while current_num < iteration_num:
    if current_num==1:
        ...
        """
    elif  best_flag == 1 or current_num %100 == 0:
    ...
    elif best_flag == 1 or (current_num>=3000 and current_num % 50 == 0):
...
saver.save_convergence_graph(objectives, name=config.folder_name+" Convergence graph iteration")
saver.save_convergence_graph_by_time(time_based_objectives, objectives, name=config.folder_name+" Convergence graph time")